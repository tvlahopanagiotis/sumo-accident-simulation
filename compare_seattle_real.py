...
Example:
  python compare_seattle_real.py \
      --sim-dir results/Seattle_Batch_2026-03-06_11:10 \
      --real-csv seattle_bundle/crash_data/sdot_collisions_all_years.csv
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--real-csv",
        default="seattle_bundle/crash_data/sdot_collisions_all_years.csv",
