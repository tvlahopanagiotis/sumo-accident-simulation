...
logger = logging.getLogger("suma.resilience")
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="suma-assess",
        description=(
            "SUMA One-Click Resilience Assessment\n\n"
    ...
    parser.add_argument(
        ...
        metavar="FILE",
        help=f"Path to base YAML config (default: {DEFAULT_CONFIG_PATH})",
    )
    parser.add_argument(
        "--workers",
        type=int,
...
def run_assessment(args: argparse.Namespace) -> None:
    ...
    from ..simulation.parallel_runner import ParallelExecutor  # noqa: PLC0415
    from ..simulation.runner import load_config, validate_config  # noqa: PLC0415
    ...
    logger.info("=" * 60)
    logger.info("  SUMA One-Click Resilience Assessment")
    logger.info("=" * 60)
