...
Post-simulation visualization module for SUMA (SUMO Accident Simulation).
...
class LiveProgressDashboard:
    ...
    def __init__(
        ...
        if self._interactive:
            try:
                plt.ion()
                self._fig.canvas.manager.set_window_title("SUMA Live Progress")
                self._fig.show()
    ...
    def update(
        ...
        *,
        ...
        title = (
            f"SUMA Live Progress  |  {pct_complete:5.1f}% complete"
...
def generate_html_report(
    ...
    html_parts = [
        ...
        "    <title>SUMA Simulation Report</title>",
        "    <style>",
    ...
    html_parts.append("            Generated by SUMA (SUMO Accident Simulation)<br>")
    html_parts.append(
