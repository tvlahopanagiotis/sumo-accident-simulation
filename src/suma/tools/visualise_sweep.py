...
visualise_sweep.py
==================
Failure-point visualisation for the SUMA parameter-grid sweep.
...
-----
    ...
    suma-visualise-sweep --csv results/sweep/sweep_results.csv
    suma-visualise-sweep --out-dir results/sweep/figs
"""
...
def main():
    ap = argparse.ArgumentParser(
        description="Visualise SUMA failure-point sweep results (publication style)",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    ap.add_argument(
        "--csv",
        default=os.path.join(REPO_ROOT, "results", "sweep", "sweep_results.csv"),
    )
    ...
    print(f"\n  SUMA — Sweep Visualiser  (academic style)")
    print(f"  {'─'*40}")
