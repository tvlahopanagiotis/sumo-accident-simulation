...
def _load_config(config_path: str = "configs/thessaloniki/default.yaml") -> dict:
    from suma.app.config import load_config
...
def _reconstruct_resilience_score(score_path: Path):
    ...
    from suma.analysis.mfd_analysis import EdgeVulnerability, ResilienceScore
...
def _reconstruct_scenarios(matrix_path: Path) -> list:
    ...
    from suma.analysis.scenario_generator import Scenario
...
def main() -> None:
    ...
    parser.add_argument(
        "--config",
        default="configs/thessaloniki/default.yaml",
        help="Path to base config (default: configs/thessaloniki/default.yaml)",
    )
    ...
    from suma.analysis.mfd_analysis import (
    ...
    from suma.analysis.resilience_report import generate_resilience_report
