...
Usage
-----
    sas-generate-sioux-falls                  # generate network + routes
    sas-generate-sioux-falls --update-config  # also patch the selected config file
    sas-generate-sioux-falls --period 2.0     # adjust vehicle density
...
def main():
    ...
    ap.add_argument(
        "--update-config",
        action="store_true",
        help="Patch the selected YAML config so SAS uses this network immediately",
    )
    ap.add_argument(
        "--config",
