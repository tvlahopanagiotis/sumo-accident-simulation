...
This script:
  ...
  5. Optionally patches a YAML config so SAS uses this network immediately
...
Usage:
  sas-generate-thessaloniki                  # build network + routes
  sas-generate-thessaloniki --update-config  # also patch the selected config file
  sas-generate-thessaloniki --period 2.0     # sparser traffic (fewer vehicles)
  sas-generate-thessaloniki --gui            # open sumo-gui after building
