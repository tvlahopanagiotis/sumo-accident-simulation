...
Usage:
  sas-generate-riverside                         # build in ./data/synthetic/riverside/network/
  sas-generate-riverside --out-dir /tmp/mynet    # custom output folder
  sas-generate-riverside --update-config         # also patch the selected config file
"""
