...
Usage:
    ...
    python analyse_batch.py --batch-dir results/Thessaloniki_Batch_2026-03-05_16:53
...
BATCH_A_DEFAULT = (
    Path(__file__).parent / "results" / "Thessaloniki_Batch_2026-03-05_16:53"
)
BATCH_B_DEFAULT = (
    Path(__file__).parent / "results" / "Thessaloniki_Batch_2026-03-05_20:31"
)
NET_XML_DEFAULT = (
    Path(__file__).parent / "thessaloniki_network" / "thessaloniki.net.xml"
)
